          ...
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <motion.div
                ...
                transition={{ duration: 1 }}
                viewport={{ once: true }}
                className="relative h-96 w-full lg:w-1/2 rounded-2xl overflow-hidden shadow-2xl"
              >
                <Image
                  src={images.mission}
          ...
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className={`text-xl font-bold mb-2 flex items-center gap-2 ${
                      ...
                      <FaShieldAlt className="text-blue-600" /> Transparency
                    </h3>
                    <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                  ...
                  <div>
                    <h3 className={`text-xl font-bold mb-2 flex items-center gap-2 ${
                      ...
                      <FaChartLine className="text-blue-600" /> Market Expertise
                    </h3>
                    <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                  ...
                  <div>
                    <h3 className={`text-xl font-bold mb-2 flex items-center gap-2 ${
                      ...
                      <FaTree className="text-blue-600" /> Sustainability
                    </h3>
                    <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                  ...
                  <div>
                    <h3 className={`text-xl font-bold mb-2 flex items-center gap-2 ${
                      ...
                      <FaTrophy className="text-blue-600" /> Excellence
                    </h3>
                    <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
              ...
              <motion.div
                ...
                transition={{ duration: 1 }}
                viewport={{ once: true }}
                className="relative h-96 w-full lg:w-1/2 rounded-2xl overflow-hidden shadow-xl"
              >
                <Image
                  src={images.office}
                  alt="Modern Office"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                  ...
                  <span className="text-sm">24/7 Virtual Consultations Available</span>
                </p>
              </motion.div>
            </div>
          ...
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/public/houses"
                  className="px-8 py-3 bg-white hover:bg-gray-100 text-blue-600 font-bold rounded-lg text-lg transition-colors duration-300 shadow-lg"
                >
                  Browse Properties
                </Link>
                <Link
